...
class ExponentialFamily(object):
    ...
    def sample_eta(self, D, N):
        raise NotImplementedError()
        
    def mu_to_eta(self, mu):
        raise NotImplementedError()
        
    def eta_to_mu(self, mu):
        raise NotImplementedError()
...
class Dirichlet(ExponentialFamily):
    ...
    def sample_eta(self, N=50):
        alpha = np.random.uniform(0.5, 2., (N, self.D))
...
class MVN(ExponentialFamily):
    ...
    def sample_eta(self, N=50):
        df_fac = 5
        mu = np.random.normal(0., 1., (N, self.D))
        df = df_fac*self.D
    ...
    def mu_to_eta(self, mu, Sigma):
        ...
        eta2[:, utri1_inds[0], utri1_inds[1]] = 2 * eta2[:, utri1_inds[0], utri1_inds[1]]
